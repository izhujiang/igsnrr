...
#MORE INFO ...
#email: 
"""TasksRunner is designed as the user interface and main entry to execute specific tools."""
# ######!/usr/bin/python
...
"""TasksRunner is designed as the user interface and main entry to execute specefic tools."""
class TasksRunner:
    def __init__(self):
        ...
        self._usagemessages = []
        self._tasks = {}
        self._parser = argparse.ArgumentParser(prog="python.exe tasksrunner.py", description="Tasks Runner Usage Guide.", prefix_chars="-+/") 
        self._parser.add_argument("--version", action="version", version='%(prog)s 0.0.1')
    ...
    def setupTools(self):
        ...
        self._subparsers = self._parser.add_subparsers(dest="toolcommand", help='Tools')
    ...
    def addTask(self, tool):
        ...
        parser = self._subparsers.add_parser(tool.getName(), help=tool.getDescription())
